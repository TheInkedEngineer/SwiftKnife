...
public extension UIDevice {
  ...
  enum PlatformName: String {
    ...
    /// the platform is an iPad5.
    case iPad5 = "iPad5"
    
    /// the platform is an iPad6.
    case iPad6 = "iPad6"
    
    /// the platform is an iPad7.
    case iPad7 = "iPad7"
  ...
  @available(*, deprecated, renamed: "hardwareString")
  var platform: String {
  ...
  @available(*, deprecated, renamed: "device")
  var platformName: Device {
    switch self.hardwareString {
